...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.14.0-green?style=flat-square" alt="Version">
...
|---------------|-------------|
| [ClaudeTerminal_1.14.0_x64-setup.exe](https://github.com/talayash/claude-terminal/releases/latest/download/ClaudeTerminal_1.14.0_x64-setup.exe) | NSIS Installer (Recommended) |
| [ClaudeTerminal_1.14.0_x64_en-US.msi](https://github.com/talayash/claude-terminal/releases/latest/download/ClaudeTerminal_1.14.0_x64_en-US.msi) | MSI Installer |
