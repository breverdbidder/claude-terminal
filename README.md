...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.8.1-green?style=flat-square" alt="Version">
...
|---------------|-------------|
| [ClaudeTerminal_1.8.1_x64-setup.exe](https://github.com/talayash/claude-terminal/releases/latest/download/ClaudeTerminal_1.8.1_x64-setup.exe) | NSIS Installer (Recommended) |
| [ClaudeTerminal_1.8.1_x64_en-US.msi](https://github.com/talayash/claude-terminal/releases/latest/download/ClaudeTerminal_1.8.1_x64_en-US.msi) | MSI Installer |
